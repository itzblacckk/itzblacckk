    ...
    <div className="flex flex-col lg:flex-row h-screen bg-gradient-to-r from-red-600 to-zinc-900 text-white">
      ...
      <div className="flex-1 p-4 lg:p-8 overflow-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center mb-8 space-y-4 lg:space-y-0">
          <input type="text" placeholder="Search for subscriptions, payouts, and reminders" className="w-full lg:w-1/2 p-2 rounded-lg bg-zinc-800 text-white placeholder-zinc-400" />
        </div>
          ...
          <div className="lg:w-1/2 lg:pl-4">
            <div className="flex flex-col justify-between items-center mb-8 space-y-4">
              ...
              <div className="flex space-x-4">
                <div>Jan <span className="bg-zinc-800 p-1 rounded-lg">9</span></div>
                <div className="bg-red-600 p-1 rounded-lg">Feb <span className="bg-zinc-800 p-1 rounded-lg">2</span></div>
                <div>Mar <span className="bg-zinc-800 p-1 rounded-lg">7</span></div>
                <div>Apr <span className="bg-zinc-800 p-1 rounded-lg">4</span></div>
                <div>May <span className="bg-zinc-800 p-1 rounded-lg">7</span></div>
                <div>Jun <span className="bg-zinc-800 p-1 rounded-lg">6</span></div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <button className="bg-red-600 p-2 rounded-lg">View full list</button>
            </div>
          </div>
